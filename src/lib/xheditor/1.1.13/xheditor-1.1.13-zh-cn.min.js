...
this.toggleFullscreen=function(a){if(la!==a){var a=d("#"+ja).find(".xheLayout"),b=d("#"+ja),e=$.browser.version,e=i&&(6==e||7==e);la?(e&&F.after(b),a.attr("style",Za),A.height(O-q.outerHeight()),d(window).scrollTop(Pa),setTimeout(function(){d(window).scrollTop(Pa)},10)):(e&&d("body").append(b),Pa=d(window).scrollTop(),Za=a.attr("style"),a.removeAttr("style"),A.height("100%"),setTimeout(Na,100));qa?(d("#"+za).show().focus().hide(),setTimeout(c.focus,1)):e&&c.setTextCursor();la=!la;b.toggleClass("xhe_Fullscreen");
